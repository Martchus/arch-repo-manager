...
void ParserTests::testParsingPackageName()
{
    ...
    CPPUNIT_ASSERT_EQUAL(false, gcc.isDebugPackage);
    ...
    CPPUNIT_ASSERT_EQUAL(false, mingwGCC.isDebugPackage);
    ...
    CPPUNIT_ASSERT_EQUAL(false, mingwUcrtCppWinrt.isDebugPackage);
    ...
    CPPUNIT_ASSERT_EQUAL(false, mingwClangEnv.isDebugPackage);
    ...
    CPPUNIT_ASSERT_EQUAL(false, mingwClangCrt.isDebugPackage);
    ...
    CPPUNIT_ASSERT_EQUAL(false, staticCompatQt6.isDebugPackage);
    ...
    CPPUNIT_ASSERT_EQUAL(false, armGCC.isDebugPackage);
    ...
    CPPUNIT_ASSERT_EQUAL(false, qt.isDebugPackage);
    ...
    CPPUNIT_ASSERT_EQUAL(false, mingwQt.isDebugPackage);
    ...
    CPPUNIT_ASSERT_EQUAL(false, qwt.isDebugPackage);
    ...
    CPPUNIT_ASSERT_EQUAL(false, androidEnv.isDebugPackage);
    ...
    CPPUNIT_ASSERT_EQUAL(false, androidArchPackage.isDebugPackage);
    CPPUNIT_ASSERT_EQUAL("android-x86-64-qt6-base"s, androidArchPackage.compose());
    const auto debugPackage = PackageNameData::decompose("android-x86-64-qt6-base-debug");
    CPPUNIT_ASSERT_EQUAL("qt6-base"sv, debugPackage.actualName);
    CPPUNIT_ASSERT_EQUAL("android-x86-64"sv, debugPackage.targetPrefix);
